...
check(s.screen.row(1)[30:].startswith(" hello.code  notes.md "), "each open file has a tab: " + s.screen.row(1)[30:56])
...
check(s.screen.row(1)[32:].startswith(" hello.code "), "ctrl+k → makes the explorer wider: " + s.screen.row(1)[28:44])
